						...
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb slick-initialized slick-slider slick-dotted">
								<div class="slick-list draggable">
									<div class="slick-track" style="opacity: 1; width: 1350px;">
										<div class="item-slick3 slick-slide slick-current slick-active" data-thumb="{{ $product->thumb }}" data-slick-index="0" aria-hidden="false" tabindex="0" role="tabpanel" id="slick-slide10" aria-describedby="slick-slide-control10" style="width: 450px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;">
    ...
    <section class="sec-relate-product bg0 p-t-45 p-b-105">
		<div class="container">
			...
			<div class="wrap-slick2">
				{{-- Btn prev --}}
				<button class="arrow-slick2 prev-slick2 slick-arrow" aria-disabled="false" style="">
					<i class="fa fa-angle-left" aria-hidden="true"></i>
				</button>
				...
				<div class="slick2 slick-initialized slick-slider">	
					<div class="slick-list draggable">
						<div class="slick-track" style="opacity: 1; width: 2304px; transform: translate3d(0px, 0px, 0px);">
							@foreach ($relatedProducts as $relatedProduct)
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15 slick-slide slick-current slick-active" tabindex="0" style="width: 288px;" data-slick-index="0" aria-hidden="false">
									<!-- Block2 -->
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ $relatedProduct->thumb }}" alt="IMG-PRODUCT">
										...
										<div class="block2-txt flex-w flex-t p-t-14">
											<div class="block2-txt-child1 flex-col-l ">
												<a href="/san-pham/{{ $relatedProduct->id }}-{{ Str::slug($relatedProduct->product_name, '-') }}.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6" tabindex="0">
													{{ $relatedProduct->product_name }}
												</a>

												<span class="stext-105 cl3">
													{!! App\Helpers\Helper::price($relatedProduct->price, $relatedProduct->price_sale) !!}
												</span>
											</div>
				...
				{{-- Btn next --}}
			    <button class="arrow-slick2 next-slick2 slick-arrow slick-disabled" aria-disabled="true" style="">
					<i class="fa fa-angle-right" aria-hidden="true"></i>
				</button>
            </div>
		</div>
