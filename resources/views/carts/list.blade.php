                    ...
                    <div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                        <div class="m-l-25 m-r--38 m-lr-0-xl">
                                ...
                                <table class="table-shopping-cart">
                                    <tbody>
                                        ...
                                        @php
                                            ...
                                            $priceOfN = $priceOfOne * $carts[$product->id];
                                            $priceTotal += $priceOfN;
                                        @endphp
                                            <tr class="table_row">
                                                <td class="column-1">
                            ...
                            <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                                ...
                                <input type="submit" formaction="/update-cart" value="Update Cart" class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10">
                                @csrf
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                        <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                            ...
                            <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                                ...
                                <div class="size-300 p-r-18 p-r-0-sm w-full-ssm">
                                    ...
                                    <div class="p-t-15">
                                        ...
                                        <div class="bor8 bg0 m-b-12">
                                            <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="email" placeholder="Email liên hệ" required>
                                        </div>
                            ...
                            <div class="flex-w flex-t p-t-27 p-b-33">
                                ...
                                <div class="size-209 p-t-1">
                                    <span class="mtext-110 cl2 bg-info text-light">
